      ...
      <div className="p-headerNav px-4">
        <div className="p-nav_container">
          ...
          <div className="p-nav_content">
            ...
            <div
              className="p-nav_icon p-nav_cart px-2 pt-[17.73px] pb-[17px] relative z-20"
              ref={refCartDropdown}>
              <button
                type="button"
              ...
              <CartDropdown
                isOpen={openCart}
                listCart={listCart}
                handleDeleteCart={handleDeleteCart}></CartDropdown>
            </div>
            <div className="p-nav_icon p-nav_notice px-2 pt-[17.73px] pb-[17px] relative">
              <button
                ...
                <div className="flex absolute h-5 w-5 top-[-8px] right-[-6px] end-0 -me-[5px]">
                  ...
                  <span className="relative inline-flex rounded-full h-[14.7px] w-[14px] text-[0.625rem] bg-red-500 text-white justify-center items-center">
                    5
                  </span>
                </div>
              </button>
            ...
            <div
              className="p-nav_user flex items-center px-8 relative cursor-pointer"
              ...
              <div className="p-user flex items-center">
                <div className="p-user_avarta w-8 h-8 flex items-center justify-center">
                  <img
                    ...
                    alt=""
                    className="inline-block rounded-full mr-3"></img>
                </div>
                <div className="p-user_info">
                  <p className="font-medium text-[12px] text-[#536485] leading-1">
                    Ngoan MC
                  </p>
                  <p className="font-light text-[11px] text-[#536485] leading-none">
                    Developer
                  </p>
                </div>
              </div>
              <div
                className={`w-[11rem] duration-100 ${openUser ? "visible translate-y-0 opacity-100" : "invisible translate-y-1 opacity-0"} bg-white absolute z-10 top-[102%] right-0 drop-shadow-xl rounded-b-sm`}>
                <ul className="text-defaulttextcolor font-medium dark:text-[#8c9097] dark:text-white/50">
                  <li>
                    <Link
                      href="#"
                      className="flex items-center hover:bg-blue-50 gap-2 p-2.5">
                      <UserCircleIcon
                    ...
                    <Link
                      ...
                      <span className="text-green-500 bg-gray-100 text-[10px] font-medium p-1.5 rounded-sm leading-none ml-auto">
                        25
                      </span>
                    </Link>
                    <Link
