            ...
            <div className='p-headerNav'>
                <div className='p-nav_container'>
                    ...
                    <div className='p-nav_content'>
                        <div className='p-nav_icon p-nav_search px-2 py-4'>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                                <path strokeLinecap="round" strokeLinejoin="round" d="M21 21l-5.197-5.197m0 0A7.5 7.5 0 105.196 5.196a7.5 7.5 0 0010.607 10.607z" />
                            </svg>
                        </div>
                        <div className='p-nav_icon p-nav_cart px-2 py-4 relative z-20' ref={refCartDropdown}>
                        ...
                        <div className='p-nav_icon p-nav_notice px-2 py-4 relative'>
                            <button type='button' className='relative !p-0 !border-0 flex-shrink-0  !rounded-full !shadow-none align-middle text-xs'>
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
